...
export const metadata: Metadata = {
  title: '서비스 종료 안내',
  description: '주섬 웹 서비스 종료 안내',
};

export default function ServiceClosed() {
  return (
    <div className="flex min-h-screen w-screen flex-col items-center justify-center gap-5 px-8 py-10">
      <h1 className="shrink-0 text-center text-24-32 font-bold text-black">서비스 종료 안내</h1>
      <div className="min-h-0 flex-1 break-keep py-4 text-16-24 font-normal tracking-[-0.2px] text-gray-800">
        <p>안녕하세요, 주섬 팀입니다.</p>
        <p className="mt-3">그동안 주섬 서비스를 이용해주신 모든 분들께 진심으로 감사드립니다.</p>
        <p className="mt-3">주섬은 서비스 운영 방향 및 내부 사정에 따라 아래 일정으로 서비스를 종료하게 되었습니다.</p>
