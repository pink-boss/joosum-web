...
interface Props {
  size?: 'lg' | 'md' | 'sm' | 'xl';
  color?: 'black' | 'blue' | 'green' | 'primary' | 'red' | 'secondary' | 'white';
  direction?: 'down' | 'left' | 'right' | 'up';
  className?: string;
}

export default function Triangle({ size = 'md', color = 'black', direction = 'up', className = '' }: Props) {
  // 방향과 크기별 클래스 설정
  const getTriangleClasses = useCallback(() => {
    ...
    const sizeClasses = {
      sm: {
        ...
        right: 'border-t-[25px] border-b-[25px] border-l-[43px] border-t-transparent border-b-transparent',
      },
      md: {
        ...
        right: 'border-t-[50px] border-b-[50px] border-l-[87px] border-t-transparent border-b-transparent',
      },
      lg: {
        ...
        right: 'border-t-[75px] border-b-[75px] border-l-[130px] border-t-transparent border-b-transparent',
      },
      xl: {
        ...
        right: 'border-t-[100px] border-b-[100px] border-l-[173px] border-t-transparent border-b-transparent',
      },
    };
    ...
    return clsx(baseClasses, sizeClasses[size][direction], colorClasses[color][direction]);
