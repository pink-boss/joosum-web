  ...
  return (
    <div
      ...
      className={clsx(
        ...
        isPreview ? 'h-44 w-32.5 rounded-lg shadow-0-2.87-2.87-0' : 'w-full flex-1 rounded-xl shadow-0-4.73-4.73-0',
      )}
    >
      <div className={clsx('absolute h-full bg-black/10', isPreview ? 'left-2.25 w-0.5' : 'left-[13.2px] w-[3.3px]')} />
      <div
        style={{ color: titleColor }}
        className={clsx(
          'font-bold',
          isPreview
            ? 'ml-5.5 mt-4 w-23.5 text-16-24 tracking-[-0.2px]'
            : 'ml-8.25 mt-[19.8px] w-30.25 text-18-21 tracking-[-0.2px]',
        )}
      >
